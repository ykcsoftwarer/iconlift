                      ...
                      <div className="footer-widget__column footer-widget__services">
                        <ul className="footer-widget__services-list">
                          <li className="footer-widget__services-list-item">
                            <Link to="/services">{data?.footerProjects}</Link>
                          </li>
                          <li className="footer-widget__services-list-item">
                            <Link to="/blog">{data?.footerRequests}</Link>
                          </li>
                          <li className="footer-widget__services-list-item">
                            <Link to="/portfolio">{data?.footerOffers}</Link>
                          </li>
                          <li className="footer-widget__services-list-item">
                            <Link to="/">{data?.footerExperience}</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="footer-widget__column footer-widget__explore">
                        ...
                        <ul className="footer-widget__explore-list">
                          <li className="footer-widget__explore-list-item">
                            <Link to="/abaut">{data?.footerPlanning}</Link>
                          </li>
                          <li className="footer-widget__explore-list-item">
                            <Link to="/">{data?.footerCost}</Link>
                          </li>
                          <li className="footer-widget__explore-list-item">
                            <Link to="/">{data?.footerViews}</Link>
                          </li>
                          <li className="footer-widget__explore-list-item">
                            <Link to="/">{data?.footerIndustry}</Link>
                          </li>
                          <li className="footer-widget__explore-list-item">
                            <Link to="/">{data?.footerReform}</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="col-xl-12">
                <div className="footer-one__bottom-inner">
                  <div className="footer-one__bottom-text">
                    <p>
                      Copyright &copy;2022. Tüm Hakları{" "}
                      <Link to="/">[YKÇ-FS-KÇ-HY]</Link> aittir.
                    </p>
                  </div>
                  ...
                  <div className="footer-one__bottom-list">
                    <ul>
                      <li>
                        <Link to="/about-one">Şartlarımız & Projelerimiz </Link>
                      </li>
                      <li>
                        <Link to="/about-one"> Hizmetler </Link>
                      </li>
                      <li>
                        <Link to="/about-one">Kariyerimiz</Link>
                      </li>
                    </ul>
                  </div>
                </div>
